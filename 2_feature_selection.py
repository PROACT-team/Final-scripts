...
Original file is located at
    https://colab.research.google.com/drive/178MY3_CC4u4YbWohb5KHg3bRg3tpyDyl
"""
...
feature_and_target # 2652 subjects
...
print(event_distribution)   # 1789 censored, 863 uncensored
...
# The other 2647 subjects are used for feature selection
...
print(df_demonstration) # 5 subjects
print(df_train) # 2117 subjects
print(df_test) # 530 subjects
...
# Selection result : ['mean_Q3_Swallowing', 'mean_Q1_Speech', 'slope_Q3_Swallowing', 'Age', 'mean_Q7_Turning_in_Bed', 'onset_delta', 'weight_slope', 'mean_Q2_Salivation', 'slope_Q1_Speech', 'fvc_mean', 'diag_delta', 'mean_Q5_Cutting', 'onset_site', 'Creatinine_mean']
...
sns.heatmap(feature_and_target.drop(columns = ['SubjectID', 'time_opt', 'status_opt']).astype(float).corr(), linewidths=0.1, vmax=1.0,
...
# Final list
feature_list = ['alsfrs_total_slope', 'Age', 'onset_delta', 'fvc_mean', 'mean_Q1_2_3_mouth', 'mean_Q7_Turning_in_Bed','slope_Q3_Swallowing','weight_slope', 'Creatinine_slope']
feature_list # 9 features