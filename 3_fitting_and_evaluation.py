...
target = pd.read_csv(io.BytesIO(uploaded['0913_optimal_target.csv'])) #target means 'time to dietary consistency change'
...
opt_data = opt_data[['SubjectID','Age', 'onset_delta', 'fvc_mean', 
                       'mean_Q1_2_3_mouth',  'mean_Q7_Turning_in_Bed', 
                       'alsfrs_total_slope', 'slope_Q3_Swallowing', 'Creatinine_slope',
...
#Result
print(grid_cv2.best_score_)  # 0.8444879944551792
print(grid_cv2.best_params_)  # {'l1_ratio': 0.2, 'penalizer': 0.2}
...
columns = [('lambda_',                    'slope_Q3_Swallowing'),
            ...
            ('lambda_',               'alsfrs_total_slope'),
            ('lambda_',            'weight_slope'),
            ('lambda_',        'Creatinine_slope'),
            ('lambda_',    'fvc_mean'),
            ('lambda_',    'onset_delta'),
            ('lambda_',           'Age')]
...
# Result
print(grid_cv.best_score_)  # 0.8443002043862222
print(grid_cv.best_params_)  # {'l1_ratio': 0.2, 'penalizer': 0.1}
...
# Variable 'onset_delta' failed the non-proportional test: p-value is 0.0012.
# Variable 'mean_Q1_2_3_mouth' failed the non-proportional test: p-value is <5e-05.
# Variable 'slope_Q3_Swallowing' failed the non-proportional test: p-value is <5e-05.
...
df_train_finalcox = df_train[['Age', 'onset_delta', 'fvc_mean',
       'mean_Q1_2_3_mouth', 'mean_Q7_Turning_in_Bed',
       'alsfrs_total_slope', 'slope_Q3_Swallowing',
        'weight_slope', 'status_opt', 'time_opt']]
...
# Result
print(grid_cv3.best_score_) # 0.8448708321619245
print(grid_cv3.best_params_) # {'max_features': 'auto', 'min_samples_leaf': 8, 'min_samples_split': 8, 'n_estimators': 100}
...
feature_names 
# ['Age','onset_delta','fvc_mean','mean_Q1_2_3_mouth','mean_Q7_Turning_in_Bed','alsfrs_total_slope','slope_Q3_Swallowing','Creatinine_slope','weight_slope']
...
import io
Feat_imp = pd.read_csv(io.BytesIO(uploaded['RSF feature importance.csv']))

Feat_imp = Feat_imp[['feature', 'weight', 'max', 'min']]

Feat_imp

Feat_imp = Feat_imp.transpose()
Feat_imp.columns = ['mean_Q1_2_3_mouth','slope_Q3_Swallowing', 'fvc_mean', 'mean_Q7_Turning_in_Bed', 'onset_delta', 'alsfrs_total_slope',
         'weight_slope',  'Age',  'Creatinine_slope']
Feat_imp = Feat_imp.iloc[1:, :]
Feat_imp

df = pd.DataFrame(data=Feat_imp, columns=['mean_Q1_2_3_mouth','slope_Q3_Swallowing', 'fvc_mean', 'mean_Q7_Turning_in_Bed', 'onset_delta', 'alsfrs_total_slope',
         'weight_slope',  'Age',  'Creatinine_slope'])
...
df_train_finalrsf = df_train[['Age','onset_delta', 'fvc_mean',
       'mean_Q1_2_3_mouth', 'mean_Q7_Turning_in_Bed',
       'alsfrs_total_slope', 'slope_Q3_Swallowing', 
        'weight_slope', 'status_opt', 'time_opt']]
...
for i in random_num_list:
    ...
    aft.fit(df_train_aft.iloc[0:2118,:], 'time_opt', event_col='status_opt')
    sco_1 = concordance_index(df_train_aft.iloc[2118:,:]['time_opt'], aft.predict_median(df_train_aft.iloc[2118:,:]), df_train_aft.iloc[2118:,:]['status_opt'])
    
    aft.fit(df_train_aft.iloc[530:,:], 'time_opt', event_col='status_opt')
    sco_2 = concordance_index(df_train_aft.iloc[0:530,:]['time_opt'], aft.predict_median(df_train_aft.iloc[0:530,:]), df_train_aft.iloc[0:530,:]['status_opt'])

    aft.fit(pd.concat([df_train_aft.iloc[0:530],df_train_aft.iloc[1060:]]), 'time_opt', event_col='status_opt')
    sco_3 = concordance_index(df_train_aft.iloc[530:1060,:]['time_opt'], aft.predict_median(df_train_aft.iloc[530:1060,:]), df_train_aft.iloc[530:1060,:]['status_opt'])

    aft.fit(pd.concat([df_train_aft.iloc[0:1060],df_train_aft.iloc[1589:]]), 'time_opt', event_col='status_opt')
    sco_4 = concordance_index(df_train_aft.iloc[1060:1589,:]['time_opt'], aft.predict_median(df_train_aft.iloc[1060:1589,:]), df_train_aft.iloc[1060:1589,:]['status_opt'])

    aft.fit(pd.concat([df_train_aft.iloc[0:1589],df_train_aft.iloc[2118:]]), 'time_opt', event_col='status_opt')
    sco_5 = concordance_index(df_train_aft.iloc[1589:2118,:]['time_opt'], aft.predict_median(df_train_aft.iloc[1589:2118,:]), df_train_aft.iloc[1589:2118,:]['status_opt'])
...
for i in random_num_list:
    ...
    cph.fit(df_train_cox.iloc[0:2118,:], 'time_opt', event_col='status_opt')
    sco_1 = concordance_index(df_train_cox.iloc[2118:,:]['time_opt'], -cph.predict_partial_hazard(df_train_cox.iloc[2118:,:]), df_train_cox.iloc[2118:,:]['status_opt'])
    
    cph.fit(df_train_cox.iloc[530:,:], 'time_opt', event_col='status_opt')
    sco_2 = concordance_index(df_train_cox.iloc[0:530,:]['time_opt'], -cph.predict_partial_hazard(df_train_cox.iloc[0:530,:]), df_train_cox.iloc[0:530,:]['status_opt'])

    cph.fit(pd.concat([df_train_cox.iloc[0:530],df_train_cox.iloc[1060:]]), 'time_opt', event_col='status_opt')
    sco_3 = concordance_index(df_train_cox.iloc[530:1060,:]['time_opt'], -cph.predict_partial_hazard(df_train_cox.iloc[530:1060,:]), df_train_cox.iloc[530:1060,:]['status_opt'])

    cph.fit(pd.concat([df_train_cox.iloc[0:1060],df_train_cox.iloc[1589:]]), 'time_opt', event_col='status_opt')
    sco_4 = concordance_index(df_train_cox.iloc[1060:1589,:]['time_opt'], -cph.predict_partial_hazard(df_train_cox.iloc[1060:1589,:]), df_train_cox.iloc[1060:1589,:]['status_opt'])

    cph.fit(pd.concat([df_train_cox.iloc[0:1589],df_train_cox.iloc[2118:]]), 'time_opt', event_col='status_opt')
    sco_5 = concordance_index(df_train_cox.iloc[1589:2118,:]['time_opt'], -cph.predict_partial_hazard(df_train_cox.iloc[1589:2118,:]), df_train_cox.iloc[1589:2118,:]['status_opt'])
...
for i in random_num_list:
    ...
    y_train_rsf_1 = np.array(list(tuple(x) for x in df_train_rsf.iloc[:2118,-2:].to_records(index=False)), dtype=dt)
    y_test_rsf_1 = np.array(list(tuple(x) for x in df_train_rsf.iloc[2118:,-2:].to_records(index=False)), dtype=dt)
    
    y_train_rsf_2 = np.array(list(tuple(x) for x in df_train_rsf.iloc[530:,-2:].to_records(index=False)), dtype=dt)
    y_test_rsf_2 = np.array(list(tuple(x) for x in df_train_rsf.iloc[0:530,-2:].to_records(index=False)), dtype=dt)
    
    y_train_rsf_3 = np.array(list(tuple(x) for x in pd.concat([df_train_rsf.iloc[0:530,-2:],df_train_rsf.iloc[1060:,-2:]]).to_records(index=False)), dtype=dt)
    y_test_rsf_3 = np.array(list(tuple(x) for x in df_train_rsf.iloc[530:1060,-2:].to_records(index=False)), dtype=dt)
    
    y_train_rsf_4 = np.array(list(tuple(x) for x in pd.concat([df_train_rsf.iloc[0:1060,-2:],df_train_rsf.iloc[1589:,-2:]]).to_records(index=False)), dtype=dt)
    y_test_rsf_4 = np.array(list(tuple(x) for x in df_train_rsf.iloc[1060:1589,-2:].to_records(index=False)), dtype=dt)
    
    y_train_rsf_5 = np.array(list(tuple(x) for x in pd.concat([df_train_rsf.iloc[0:1589,-2:],df_train_rsf.iloc[2118:,-2:]]).to_records(index=False)), dtype=dt)
    y_test_rsf_5 = np.array(list(tuple(x) for x in df_train_rsf.iloc[1589:2118,-2:].to_records(index=False)), dtype=dt)
    
    
    rsf.fit(df_train_rsf.iloc[0:2118,:-2], y_train_rsf_1)
    sco_1 = rsf.score(df_train_rsf.iloc[2118:,:-2], y_test_rsf_1)
    
    rsf.fit(df_train_rsf.iloc[530:,:-2], y_train_rsf_2)
    sco_2 = rsf.score(df_train_rsf.iloc[0:530,:-2], y_test_rsf_2)
    
    rsf.fit(pd.concat([df_train_rsf.iloc[0:530,:-2],df_train_rsf.iloc[1060:,:-2]]), y_train_rsf_3)
    sco_3 = rsf.score(df_train_rsf.iloc[530:1060,:-2], y_test_rsf_3)
    
    rsf.fit(pd.concat([df_train_rsf.iloc[0:1060,:-2],df_train_rsf.iloc[1589:,:-2]]), y_train_rsf_4)
    sco_4 = rsf.score(df_train_rsf.iloc[1060:1589,:-2], y_test_rsf_4)
    
    rsf.fit(pd.concat([df_train_rsf.iloc[0:1589,:-2],df_train_rsf.iloc[2118:,:-2]]), y_train_rsf_5)
    sco_5 = rsf.score(df_train_rsf.iloc[1589:2118,:-2], y_test_rsf_5)
...
palette = {1762:'#5698C6', 1428:'#FF9539',   2604:'#60B760',   2522:'#DB4142',  1330: "#AE8CCD"}
...
tes_1_rsf = test_1[['Age','onset_delta', 'fvc_mean',
       'mean_Q1_2_3_mouth', 'mean_Q7_Turning_in_Bed',
       'alsfrs_total_slope', 'slope_Q3_Swallowing', 
        'weight_slope']]
...
finalaft_feature_list = ['Age', 'onset_delta', 'fvc_mean',  
                       'mean_Q1_2_3_mouth',  'mean_Q7_Turning_in_Bed', 
                       'alsfrs_total_slope', 'slope_Q3_Swallowing', 
                      'weight_slope']

# X_full is train data including 'SubjectID'
X_full = opt_data[~(opt_data['SubjectID'].isin(testID_list))]

# Extract median probability time
aft_median = pd.concat([X_full['SubjectID'],aft.predict_median(df_train_finalaft)], axis=1)
aft_median # 2647 subjects
...
aft_slow_list = list(aft_median[aft_median[0] >= 	802.760469]['SubjectID'])
aft_intermediate_list = list(aft_median[(aft_median[0] >= 354.219898) & (aft_median[0] < 	802.760469)]['SubjectID'])
aft_rapid_list = list(aft_median[aft_median[0]  < 354.219898]['SubjectID'])
...
finalcox_feature_list = ['Age', 'onset_delta', 'fvc_mean',  
                       'mean_Q1_2_3_mouth',  'mean_Q7_Turning_in_Bed', 
                       'alsfrs_total_slope', 'slope_Q3_Swallowing', 
                      'weight_slope']

# Extract median probability time
cph_median = pd.concat([X_full['SubjectID'],cph.predict_median(df_train_finalcox)], axis=1)
cph_median # 2647 subjects

# Check how many subjects have infinity values on median prob time
print('There are ' + str(cph_median.replace([np.inf,-np.inf], np.nan).isnull().sum(axis = 0).iloc[1]) + ' inf values in cph_median')
# There are 11 inf values in cph_median
...
# Categorize into 3 group based on interquartile range
cph_slow_list = list(cph_median[cph_median[0.5] >= 839]['SubjectID'])
cph_intermediate_list = list(cph_median[(cph_median[0.5] >= 362) & (cph_median[0.5] < 839)]['SubjectID'])
cph_rapid_list = list(cph_median[cph_median[0.5]  < 362]['SubjectID'])
...
finalrsf_feature_list = ['Age', 'onset_delta', 'fvc_mean',  
                       'mean_Q1_2_3_mouth', 'mean_Q7_Turning_in_Bed', 
                       'alsfrs_total_slope', 'slope_Q3_Swallowing', 
                      'weight_slope']
...
cph_KM_rapid = kmf1.fit(X_cph_rapid["time_opt"], X_cph_rapid["status_opt"])
cph_KM_intermediate = kmf2.fit(X_cph_intermediate["time_opt"], X_cph_intermediate["status_opt"])
cph_KM_slow = kmf3.fit(X_cph_slow["time_opt"], X_cph_slow["status_opt"])

aft_KM_rapid = kmf4.fit(X_aft_rapid["time_opt"], X_aft_rapid["status_opt"])
aft_KM_intermediate = kmf5.fit(X_aft_intermediate["time_opt"], X_aft_intermediate["status_opt"])
aft_KM_slow = kmf6.fit(X_aft_slow["time_opt"], X_aft_slow["status_opt"])

rsf_KM_rapid = kmf7.fit(X_rsf_rapid["time_opt"], X_rsf_rapid["status_opt"])
rsf_KM_intermediate = kmf8.fit(X_rsf_intermediate["time_opt"], X_rsf_intermediate["status_opt"])
rsf_KM_slow = kmf9.fit(X_rsf_slow["time_opt"], X_rsf_slow["status_opt"])
...
GS_AFT_list = [['KM rapid', aft_KM_rapid.percentile(0.25), aft_KM_rapid.percentile(0.5), aft_KM_rapid.percentile(0.75)],
               ['Aft rapid', aft.predict_percentile(df=VIRT_aft_rapid, ancillary=None, p=0.25)[0], aft.predict_median(VIRT_aft_rapid)[0], aft.predict_percentile(df=VIRT_aft_rapid, ancillary=None, p=0.75)[0]],
               ...
               ['Aft intermediate', aft.predict_percentile(df=VIRT_aft_intermediate, ancillary=None, p=0.25)[0], aft.predict_median(VIRT_aft_intermediate)[0], aft.predict_percentile(df=VIRT_aft_intermediate, ancillary=None, p=0.75)[0]],
...
GS_COX_list = [['KM rapid', cph_KM_rapid.percentile(0.25), cph_KM_rapid.percentile(0.5), cph_KM_rapid.percentile(0.75)],
               ['Cox rapid', cph.predict_percentile(VIRT_cph_rapid, 0.25), cph.predict_median(VIRT_cph_rapid), cph.predict_percentile(VIRT_cph_rapid, 0.75)],
               ...
               ['Cox intermediate', cph.predict_percentile(VIRT_cph_intermediate, 0.25), cph.predict_median(VIRT_cph_intermediate), cph.predict_percentile(VIRT_cph_intermediate, 0.75)],
...
GS_RSF_list = [['KM rapid', rsf_KM_rapid.percentile(0.25), rsf_KM_rapid.percentile(0.5), rsf_KM_rapid.percentile(0.75)],
               ['Rsf rapid', predict_rsf_percentile(VIRT_rsf_rapid, 0.25), predict_rsf_percentile(VIRT_rsf_rapid, 0.5), predict_rsf_percentile(VIRT_rsf_rapid, 0.75)],
               ...
               ['Rsf intermediate', predict_rsf_percentile(VIRT_rsf_intermediate, 0.25), predict_rsf_percentile(VIRT_rsf_intermediate, 0.5), predict_rsf_percentile(VIRT_rsf_intermediate, 0.75)],
...
rect5 = mp.patches.Rectangle((GS_RSF.iloc[4,3],1.8), 2000, 0.4, edgecolor='white', facecolor='#009000')
